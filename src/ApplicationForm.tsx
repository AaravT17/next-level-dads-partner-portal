...
function ApplicationForm({ onSubmitted }: Props) {
  ...
  function handlePhoneChange(field: 'phone' | 'contactPhone', value: string | undefined) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (formData.phone && !isValidPhoneNumber(formData.phone)) {
      setError('Organization phone number is not valid.')
      return
    }
    if (formData.contactPhone && !isValidPhoneNumber(formData.contactPhone)) {
      setError('Contact phone number is not valid.')
      return
    }
