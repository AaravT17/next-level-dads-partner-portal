    ...
    return (
        <>
            <div 
                ...
                className={`fixed inset-0 z-10 bg-black/80 transition-opacity duration-200 ${showSidebar ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
                >
            </div>
            <aside 
            ...
            >
                ...
                <div className="flex flex-col mt-2 mx-2 gap-1 text-[15px]">
                    ...
                    <NavLink to={restricted ? "/" : "messaging"} className="sidebar-link">
